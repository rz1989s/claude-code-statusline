...
**Note on v2.1.155**: skipped (never published to npm — the registry jumps 2.1.154 → 2.1.156). Cross-source agreement (npm `latest`=2.1.157 + GitHub `CHANGELOG.md` + code.claude.com docs + installed binary) confirms v2.1.157 as the newest release with no statusline-facing schema impact.
